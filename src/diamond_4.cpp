...
namespace diamond_4 {
    ...
    void test1() {
...

        {
            ...
            buff_acc_lib::buffer<int> d(q, N, "d");
            buff_acc_lib::buffer<int> e(q, N, "e");
            buff_acc_lib::buffer<int> f(q, N, "f");
            buff_acc_lib::buffer<int> g(q, N, "g");
            buff_acc_lib::buffer<int> h(q, N, "h");

            {
                buff_acc_lib::host_accessor host_acc_a(a, sycl::access::mode::write);
                buff_acc_lib::host_accessor host_acc_b(b, sycl::access::mode::write);
                buff_acc_lib::host_accessor host_acc_d(d, sycl::access::mode::write);
                buff_acc_lib::host_accessor host_acc_f(f, sycl::access::mode::write);
            ...
            sycl::event a_b_c = q.submit([&](sycl::handler& h) {
                buff_acc_lib::accessor acc_a(a, h, sycl::access::mode::read);
                buff_acc_lib::accessor acc_b(b, h, sycl::access::mode::read);
                buff_acc_lib::accessor acc_c(c, h, sycl::access::mode::write);
            ...
            sycl::event c_d_e = q.submit([&](sycl::handler& h) {
                buff_acc_lib::accessor acc_c(c, h, sycl::access::mode::read);
                buff_acc_lib::accessor acc_d(d, h, sycl::access::mode::read);
                buff_acc_lib::accessor acc_e(e, h, sycl::access::mode::write);
                h.parallel_for(sycl::range<1>(N), [=](sycl::id<1> idx) {
            ...
            sycl::event c_f_g = q.submit([&](sycl::handler& h) {
                buff_acc_lib::accessor acc_c(c, h, sycl::access::mode::read);
                buff_acc_lib::accessor acc_f(f, h, sycl::access::mode::read);
                buff_acc_lib::accessor acc_g(g, h, sycl::access::mode::write);
                h.parallel_for(sycl::range<1>(N), [=](sycl::id<1> idx) {
            ...
            sycl::event e_g_h = q.submit([&](sycl::handler& hdl) {
                buff_acc_lib::accessor acc_e(e, hdl, sycl::access::mode::read);
                buff_acc_lib::accessor acc_g(g, hdl, sycl::access::mode::read);
                buff_acc_lib::accessor acc_h(h, hdl, sycl::access::mode::write);
            ...
            {
                buff_acc_lib::host_accessor host_acc_h(h, sycl::access::mode::read);
                long long count = 0;
                for (size_t i = 0; i < N; ++i) {
                    count += host_acc_h[i];
                }
